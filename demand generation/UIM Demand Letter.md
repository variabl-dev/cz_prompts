...
- Multi-sentence recitations of what the third-party carrier processed administratively before tendering its limits

A single short acknowledgement that the third-party carrier accepted liability or tendered its limits is acceptable when documented; do NOT expand that acknowledgement into a paragraph of policy-paperwork detail.
